...
func void B_InitMonsterAttitudes ()
{
	...
	B_SetMonsterAttitude	(GIL_SEPERATOR_HUM,	ATT_FRIENDLY,	GIL_SUMMONED_SKELETON		);
	...
	B_SetMonsterAttitude	(GIL_SKELETON,	ATT_FRIENDLY,	GIL_STONEGOLEM				);
	...
	B_SetMonsterAttitude	(GIL_SKELETON,	ATT_FRIENDLY,	GIL_TROLL					);	// Troll / Schwarzer Troll
	...
	B_SetMonsterAttitude	(GIL_SUMMONED_SKELETON,	ATT_FRIENDLY,	GIL_SEPERATOR_HUM			);
	...
	B_SetMonsterAttitude	(GIL_ZOMBIE,	ATT_FRIENDLY,	GIL_STONEGOLEM				);
	...
	B_SetMonsterAttitude	(GIL_ZOMBIE,	ATT_FRIENDLY,	GIL_TROLL					);	// Troll / Schwarzer Troll
	...
	B_SetMonsterAttitude	(GIL_STONEGOLEM,	ATT_FRIENDLY,	GIL_SKELETON				);
	...
	B_SetMonsterAttitude	(GIL_STONEGOLEM,	ATT_FRIENDLY,	GIL_ZOMBIE					);
	...
	B_SetMonsterAttitude	(GIL_STONEGOLEM,	ATT_FRIENDLY,	GIL_STONEGOLEM				);
	...
	B_SetMonsterAttitude	(GIL_STONEGOLEM,	ATT_FRIENDLY,	GIL_TROLL					);	// Troll / Schwarzer Troll
	...
	B_SetMonsterAttitude	(GIL_TROLL,	ATT_FRIENDLY,	GIL_SKELETON				);
	...
	B_SetMonsterAttitude	(GIL_TROLL,	ATT_FRIENDLY,	GIL_ZOMBIE					);
	...
	B_SetMonsterAttitude	(GIL_TROLL,	ATT_FRIENDLY,	GIL_STONEGOLEM				);
	...
	B_SetMonsterAttitude	(GIL_TROLL,	ATT_FRIENDLY,	GIL_TROLL					);	// Troll / Schwarzer Troll
