...
const int AIV_Moving 					= 89;
const int AIV_WirdVersorgt 					= 90;
const int AIV_Wiederbelebt 					= 91;
const int AIV_Versorgungszeit 					= 92;
const int AIV_LastVersorgt 					= 93;
const int AIV_ItemSammler 					= 94;
const int AIV_BossGesichtet 					= 95;
const int AIV_Belebt					= 96;
const int AIV_SlowMotion					= 97;
const int AIV_Markiert					= 98;
...
// ******************************
//---------------------------------------------
const int PERC_DIST_SUMMONED_ACTIVE_MAX	= 5000;	// Maximale Reichweite der aktiven Wahrnehmung aller beschworenen Monster
const int PERC_DIST_MONSTER_ACTIVE_MAX	= 5000; // Maximale Reichweite der aktiven Wahrnehmung ALLER anderen Monster
const int PERC_DIST_ORC_ACTIVE_MAX		= 5000; // 
const int PERC_DIST_DRAGON_ACTIVE_MAX	= 3500; //Damit das Vlippern endlich ein Ende hat
//---------------------------------------------
const int FIGHT_DIST_MONSTER_ATTACKRANGE = 2500;	// Wann greifen Monster an bzw. ab welcher Distanz vertreiben sie dich vom Fressen
const int FIGHT_DIST_MONSTER_FLEE		= 300;	// Ab wann fliehe ich vor einem Feind
const int FIGHT_DIST_DRAGON_MAGIC		= 700;
//---------------------------------------------
const int MONSTER_THREATEN_TIME			= 0; 	// Sekunden, die Monster drohen, bevor sie angreifen (wenn Gegner nicht zu weit und nicht zu nah)
const int MONSTER_SUMMON_TIME			= 999999;
...
// -------------------------------------------
var int HAI_TIME_UNCONSCIOUS;			/*= 30;*/	// MUSS SO HEISSEN, ist vom Programm ausgelagert (Default = 20) - Zeit in Sekunden, die der SC und NSCs bewußtlos bleiben
// -------------------------------------------
